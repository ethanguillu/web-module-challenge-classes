...
class Instructor extends Lambdasian{
  constructor({name, age, location, specialty, favLanguage, cathcPhrase}) {
    super({name, age, location, specialty, favLanguage, cathcPhrase});
...
class ProjectManager extends Instructor{
   constructor({name, age, location, specialty, favLanguage, cathcPhrase, gradClassName, favInstructor}) {
    super ({name, age, location, specialty, favLanguage, cathcPhrase, gradClassName, favInstructor});
